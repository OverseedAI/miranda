...
import { VideoWorthinessSchema, type VideoWorthiness } from "./schemas";
...
const modelWithStructuredOutput = model.withStructuredOutput(VideoWorthinessSchema, {
    name: "video_worthiness_analysis",
});

export async function analyzeArticle(article: RawArticle): Promise<VideoWorthiness> {
